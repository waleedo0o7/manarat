            ...
            <div class="row">
                            ...
                            <div class="nav-tabs-wrapper">
                                ...
                                <ul class="nav nav-tabs justify-content-center" id="myTab" role="tablist">
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link active" id="firstTab-tab" data-toggle="tab" data-target="#firstTab"> First Tab </button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link" id="secondTab-tab" data-toggle="tab" data-target="#secondTab"> Second Tab </button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link" id="thirdTab-tab" data-toggle="tab" data-target="#thirdTab"> Third Tab </button>
                                    </li>
                                </ul>
                ...
                <div class="col-md-6">
                    ...
                    <div class="ds-sub-section mb-5">
                        ...
                        <div class="custom-tabs-wrapper style3">
                ...
                <div class="col-md-6">
                    ...
                    <div class="ds-sub-section mb-5">
                        ...
                        <div class="custom-tabs-wrapper style4">
                ...
                <div class="accordion-item">
                    <div class="accordion-item-header" id="headingOne">
                        <button class="accordion-button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                            <p class="m-0 lead font-medium"> Collapsible Group Item #1 </p>
                            <i class="accordion-button-icon icon icon-chevron-bottom"></i>
                        </button>
                    </div>
                ...
                <div class="accordion-item">
                    <div class="accordion-item-header" id="headingTwo">
                        <button class="accordion-button collapsed" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                            <p class="m-0 lead font-medium"> Collapsible Group Item #2 </p>
                            <i class="accordion-button-icon icon icon-chevron-bottom"></i>
                        </button>
                    </div>
                ...
                <div class="accordion-item">
                    <div class="accordion-item-header" id="headingThree">
                        <button class="accordion-button collapsed" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                            <p class="m-0 lead font-medium"> Collapsible Group Item #3 </p>
                            <i class="accordion-button-icon icon icon-chevron-bottom"></i>
                        </button>
                    </div>
