        ...
        <div class="container">
            ...
            <div class="ds-sub-section">
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-md-2">
                        <p class="m-0 mt-3 lead"> Daterange </p>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group m-0">
                                    <div class="relative">
                                        <input type="text" class="form-control" id="date_from" placeholder="From" readonly>
                                        <div class="end-content">
                                            <i class="icon icon-lg icon-calendar color-gray"></i>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group m-0">
                                    <div class="relative">
                                        <input type="text" class="form-control" id="date_to" placeholder="To" readonly>
                                        <div class="end-content">
                                            <i class="icon icon-lg icon-calendar color-gray"></i>
                                        </div>
                                    </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-2">
                        <p class="m-0 mt-3 lead"> Flatpickr Daterange </p>
                    </div>
                    ...
                    <div class="col-md-10">
                        <div class="row">
                            <div class="col-md-8">
                                <div class="form-group m-0">
                                    <div class="relative flatpickr-daterange-wrapper">
                                        <input type="text" class="form-control flatpickr-daterange" placeholder="From                                               To ">
                                        <div class="end-content">
                                            <i class="icon icon-lg icon-calendar color-gray"></i>
                                        </div>
                                    </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <h5 class="main-label mb-3"> Colors images buttons </h5>


                    <div class="custom-radio-wrapper images-radio-wrapper">

                        <div class="custom-control custom-radio custom-control-inline">
                            <input type="radio" id="customRadioColors1" name="colors" class="custom-control-input" checked>
                            <label class="custom-control-label" for="customRadioColors1">
                                <img src="assets/img/select-1.png" class="radio-image" alt="">
                            </label>
                        </div>

                        <div class="custom-control custom-radio custom-control-inline">
                            <input type="radio" id="customRadioColors2" name="colors" class="custom-control-input">
                            <label class="custom-control-label" for="customRadioColors2">
                                <img src="assets/img/select-2.png" class="radio-image" alt="">
                            </label>
                        </div>


                        <div class="custom-control custom-radio custom-control-inline">
                            <input type="radio" id="customRadioColors3" name="colors" class="custom-control-input">
                            <label class="custom-control-label" for="customRadioColors3">
                                <img src="assets/img/select-3.png" class="radio-image" alt="">
                            </label>
                        </div>


                        <div class="custom-control custom-radio custom-control-inline">
                            <input type="radio" id="customRadioColors4" name="colors" class="custom-control-input">
                            <label class="custom-control-label" for="customRadioColors4">
                                <img src="assets/img/select-4.png" class="radio-image" alt="">
                            </label>
                        </div>


                        <div class="custom-control custom-radio custom-control-inline">
                            <input type="radio" id="customRadioColors5" name="colors" class="custom-control-input">
                            <label class="custom-control-label" for="customRadioColors5">
                                <img src="assets/img/select-5.png" class="radio-image" alt="">
                            </label>
                        </div>

                        <div class="custom-control custom-radio custom-control-inline">
                            <input type="radio" id="customRadioColors6" name="colors" class="custom-control-input" disabled>
                            <label class="custom-control-label" for="customRadioColors6">
                                <img src="assets/img/select-5.png" class="radio-image" alt="">
                            </label>
                        </div>
                    ...
                    <h5 class="main-label mb-3"> Radio buttons style </h5>

                    <div class="attributes-options default mb-4">
                    ...
                    <h5 class="main-label mb-3"> checkbox buttons style </h5>
                    ...
                    <div class="card mb-4">
                        ...
                        <h5 class="main-label mb-3"> checkbox buttons ( buttons-style ) </h5>

                        <div class="attributes-options default buttons-style ">
                    ...
                    <div class="card mb-4">
                        ...
                        <h5 class="main-label mb-3"> checkbox buttons ( colors-style ) </h5>

                        <div class="attributes-options default colors-style ">

                            <label class="option-container option-inline">
                                <input type="checkbox" checked="checked" name="colors" value="1">
                                <span class="checkmark">
                                    <span class="d-inline-flex w-10px h-10px bg-danger base-border-radius me-1"></span>
                                    Red
                                </span>
                            </label>
                            ...
                            <label class="option-container option-inline">
                                ...
                                <span class="checkmark">
                                    <span class="d-inline-flex w-10px h-10px bg-success base-border-radius me-1"></span>
                                    Green
                                </span>
                            </label>
                            ...
                            <label class="option-container option-inline">
                                <input type="checkbox" name="colors" value="1">
                                <span class="checkmark">
                                    <span class="d-inline-flex w-10px h-10px bg-warning base-border-radius me-1"></span>
                                    Yellow
                                </span>
                            </label>
                            ...
                            <label class="option-container option-inline">
                                <input type="checkbox" name="colors" value="1">
                                <span class="checkmark">
                                    <span class="d-inline-flex w-10px h-10px bg-primary base-border-radius me-1"></span>
                                    blue
                                </span>
                            </label>
