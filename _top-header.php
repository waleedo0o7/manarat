...
<div class="header-wrapper" id="top-bar-wrapper">
    ...
    <div class="container">
        ...
        <div class="web-app-top-bar" id="top-bar">

            <div class="start flex-center gap-3">

                <a href="homepage.php?dir=rtl" class="logo-link">
                    <img src="assets/images/icons-svg/logo.svg" class="logo">
                </a>
    ...
    <div class="top">
        ...
        <div class="menu-wrapper mb-4">
            ...
            <ul class="links-list">
                ...
                <li class="nav-item">
                    <a class="nav-link dropdown-toggle" href="#" onclick="toggle(this)"> مينيو 1 </a>
                    ...
                    <ul class="dropdown-menu d-none">
                        ...
                        <li class="nav-item">
                            <a class="nav-link dropdown-toggle" href="#" onclick="toggle(this)"> مينيو 1-3 </a>
                            ...
                            <ul class="dropdown-menu d-none">
                                ...
                                <li class="nav-item ">
                                    ...
                                    <a href="#" class="nav-link  dropdown-toggle" onclick="toggle(this)">
                                        مينيو 3-1-4
                                    </a>
